...
//        http://192.168.1.191
//        "http://192.168.1.35:8081/medic-progect/"
...
常见问题：如果还没有实现交互。
可能：1.就是h5页面没有进行数据的部署。2.就是你写的交互方法单词错误。3.没有同意js交互（setJavascriptEnabled(true）)4.仔细检查你的代码。如果确定没有问题，就让h5对他的代码进行检查。或者找ios端看看他是否能够交互。
